...
import 'package:cenafood/network/repositories/food_category_repository.dart';
import 'package:cenafood/network/repositories/food_type_repository.dart';
...
class _ExploreScreenState extends State<ExploreScreen> {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Padding(
                              padding: EdgeInsets.only(
                                left: 16,
                                right: (index == foodCategories.length - 1)
                                    ? 16
                                    : 0,
                              ),
                ...
                child: FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      List<FoodType> foodTypes =
                          snapshot.data as List<FoodType>;
                      if (snapshot.hasData) {
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Padding(
                              ...
                              child: _buildPopularItemCard(
                                ...
                                discountPrice: foodTypes[index].price -
                                    (foodTypes[index].price * (30 / 100)),
                                onTap: () {},
                              ),
                            );
                          },
  ...
  Widget _buildFoodCategoryCard(
      {String? name, String? image, VoidCallback? onTap}) {
