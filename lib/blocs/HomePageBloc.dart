...
class HomePageBloc with ChangeNotifier {
  ...
  List<ShopProduct> popularProductList = [];
  List<ShopProduct> bannerProductList = [];
  ...
  getCurrentUser() {
    mAuthMethods.getUserAccount("admin", "admin").then((currentUser) {
  ...
  getCategoryFoodList() {
    ...
    // userProfile.fetchCategory().then((List<Category> cList) {
    categoryList.add(recentlyCategory2);
    categoryList.add(recentlyCategory);
    categoryList.add(recentlyCategory3);
    categoryList.add(recentlyCategory4);
