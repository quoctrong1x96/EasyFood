...
class _HomePageContentState extends State<HomePageContent> {
  ...
  createbanner() {
    ...
    final List<Widget> imageSliders = homePageBloc!.bannerProductList
        ...
        children: <Widget>[
          DrawerHeader(
            child: UserAccountsDrawerHeader(
              ...
              accountName: Text(""),
              accountEmail: Text(homePageBloc!.userProfile.name),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            height: 200.0,
            child: homePageBloc!.popularProductList.length == -1
                ? Center(child: Center(child: CircularProgressIndicator()))
                : ListView.builder(
                    scrollDirection: Axis.horizontal,
                    itemCount: homePageBloc!.popularProductList.length,
                    itemBuilder: (_, index) {
                      return FoodTitleWidget(
                        homePageBloc!.popularProductList[index],
                      );
                    }),
          ),
        ],
  ...
  createForYou() {
    return Container(
      ...
      margin: EdgeInsets.symmetric(vertical: 20.0),
      child: //homePageBloc!.productList.length == 0?
          Center(child: CircularProgressIndicator()),
      // : ListView.builder(
